...
class USB_CONNECTION_STATUS(IntEnum):
    NO_DEVICE_CONNECTED = 0
    DEVICE_CONNECTED = 1
    DEVICE_FAILED_ENUMERATION = 2
    DEVICE_GENERAL_FAILURE = 3
    DEVICE_CAUSED_OVERCURRENT = 4
    DEVICE_NOT_ENOUGH_POWER = 5
    DEVICE_NOT_ENOUGH_BANDWIDTH = 6
    DEVICE_HUB_NESTED_TOO_DEEPLY = 7
    DEVICE_IN_LEGACY_HUB = 8
    DEVICE_ENUMERATING = 9
    DEVICE_RESET = 10
